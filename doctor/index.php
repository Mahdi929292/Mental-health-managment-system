            ...
            <div class="row">
                ...
                <div class="col-md-10">
                 <div class="container-fluid">
                    ...
                    <div class="col-md-12">
                        <div class="row">
                            <div class="col-md-3 my-2 bg-dark" style="height:150px;">
                             <div class="col-md-12">
                                <div class="row">
                                    <div class="col-md-8">
                            ...
                            <div class="col-md-3 my-2 bg-danger" style="height:150px;">
                             <div class="col-md-12">
                                <div class="row">
                                    <div class="col-md-8">
                                        <?php
                                         $app=mysqli_query($connection,"SELECT * FROM appointment WHERE status='Pendding'") ;
                                        $appointment=mysqli_num_rows($app);
                                        ?>
                                    <h5 class="text-white my-2" style="font-size:30px"><?php echo $appointment ;?></h5>
                                    <h5 class="text-white ">Total</h5>
